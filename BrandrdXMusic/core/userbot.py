...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("TG_BIO_STYLE")
                await self.three.join_chat("SIDHI_MUSIC")
                await self.three.join_chat("SIDHI_MUSIC")
                await self.three.join_chat("TG_BIO_STYLE")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("TG_BIO_STYLE")
                await self.four.join_chat("SIDHI_MUSIC")
                await self.four.join_chat("SIDHI_MUSIC")
                await self.four.join_chat("TG_BIO_STYLE")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("TG_BIO_STYLE")
                await self.five.join_chat("SIDHI_MUSIC")
                await self.five.join_chat("SIDHI_MUSIC")
                await self.five.join_chat("TG_BIO_STYLE")
            except:
                pass
